...
const Card = styled(Link)`
  ...
  /* Hover out: el texto mantiene blanco un momento para que no coincida con el fondo negro que se retira */
  &:not(:hover) span,
  &:not(:hover) strong {
    transition-delay: 0.4s;
  }

  /* Primera columna y primera fila: añadir borde izquierdo y superior (cada arista se dibuja una sola vez) */
  &:first-child {
    border-left: ${BORDER};
    border-top: ${BORDER};
  }
